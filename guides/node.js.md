...
## Coding Style
  ...
  We follow AirBnb [coding style](https://github.com/airbnb/javascript), you can check the ECMA 5 features available in node [here](https://github.com/joyent/node/wiki/ECMA-5-Mozilla-Features-Implemented-in-V8)
