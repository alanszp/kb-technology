...
## Coding Style
  ...
  We use a Sublime linter plugin with a .jshintrc file, you can check the ECMA 5 features available in node [here](https://github.com/joyent/node/wiki/ECMA-5-Mozilla-Features-Implemented-in-V8)
